...
final class ShopWarehouseTest extends BaseApiTestCase
{
    public function testCreate()
    {
        ...
        $responseEntity = $this->api->shopWarehouses->Create('1', $requestEntity, []);
    ...
    public function testUpdate()
    {
        ...
        $responseEntity = $this->api->shopWarehouses->Update('1', Identifier::fromId(1), $requestEntity, []);
    ...
    {
        $responseEntity = $this->api->shopWarehouses->Delete('1', Identifier::fromId(1), []);
    }
}
